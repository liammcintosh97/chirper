...
<div>
  <form wire:submit="update">
    <textarea
      wire:model="message"
      class="block w-full border-gray-300 focus:border-inidigo-300 focus:ring focu:ring-inidigo-200 focus:ring-opacity-50 rounded-md shadow-sm"
    ></textarea>
